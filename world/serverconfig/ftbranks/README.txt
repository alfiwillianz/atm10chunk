...
Last README file update: Fri Feb 13 14:18:59 WIB 2026
...
command.chests
command.chests.tracker
command.chests.tracker.disable
command.chests.tracker.enable
command.clear
...
command.gatheringchunks
command.gatheringchunks.help
command.gatheringchunks.help.topic
command.gatheringchunks.spawnChunk
command.gatheringchunks.spawnChunk.location
command.gatheringchunks.spawnRandomChunk
command.gatheringchunks.spawnRandomChunk.location
command.gatheringchunks.spawnThemedChunk
command.gatheringchunks.spawnThemedChunk.theme
command.gatheringchunks.spawnThemedChunk.theme.location
command.give
...
command.lootr.cull
command.lootr.custom-area
command.lootr.custom-area.from
command.lootr.custom-area.from.to
